...
const GroupPage = (props) => {
    ...
    const splitamount = () => {
        ...
        axios.post('http://18.219.109.160:4000/createsplits', data)
            .then(response => {
    ...
    const saveExpense = (e) => {
        ...
        axios.post('http://18.219.109.160:4000/addexpense', data)
            .then(response => {
                console.log(response);
    ...
    const getAllExpenses = () => {
        axios.post('http://18.219.109.160:4000/fetchexpenses', {
            groupName: GroupName
        }).then(response => {
            if (response.data.status === true) {
    ...
    const leaveGroup = () => {
        ...
        axios.post('http://18.219.109.160:4000/getsummary', data1)
            .then(response => {
                console.log(response);
                if (response.data.giveAmount == null) {
                    ...
                    axios.post('http://18.219.109.160:4000/changestatus', data3)
                        .then(response => {
                            console.log(response);
                            if (response.data.status === true) {
