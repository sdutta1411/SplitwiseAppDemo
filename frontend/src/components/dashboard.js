...
const Dashboard = () => {
  ...
  const getSummary = () => {
    ...
    axios.post('http://18.219.109.160:4000/getsummary', data)
      .then(response => {
  ...
  const fetchAllUserids = () => {
    axios.post('http://18.219.109.160:4000/fetchallusers')
      .then(response => {
        console.log(response);
  ...
  const onSettleUp = (e) => {
     ...
     axios.post('http://18.219.109.160:4000/settleup', data2)
     .then(response => {
      console.log(response);
